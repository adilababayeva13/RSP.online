...
sessionStorage.setItem("player", json.username);
 ...
 function CheckPlayerProtect(){
 firebase.database().ref().once("value", snapshot => {
  var json=snapshot.val();
  var n1=json.player1.username;
  var n2=json.player2.username;
  var session= sessionStorage.getItem("player");
 if(session== n1){
   $("#absol2").css("visibility","visible");
   }
 if(session== n2){
  $("#absol1").css("visibility","visible");
